...
export default function UserManagementPageHRD() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-gray-100">
      ...
      <Card className="p-6 space-y-6 border border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-md">
          ...
          <div>
            ...
            <Select
              ...
              options={Object.keys(positionMap)
                .filter((role) => role !== "Admin") // Hapus role Admin
                .map((role) => ({
                  label: role,
                  value: role,
                }))}
        ...
        <Button onClick={handleCreate} className="mt-4 w-fit flex items-center gap-2">
